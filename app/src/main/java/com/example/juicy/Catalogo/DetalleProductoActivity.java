...
public class DetalleProductoActivity extends AppCompatActivity {
    ...
    private void prepararYAnadirAlCarrito() {
        ...
        try {
            if (productoActual.getPermite_personalizacion() == 1) { // Solo añadir si se personalizó
                personalizaciones.put("tamaño", tamañoSeleccionado);
                personalizaciones.put("azucar", azucarSeleccionado);
            }
        } catch (JSONException e) {
            Log.e(TAG, "Error creando JSON de personalización");
        }
        ...
        String resumen = "Añadido:\n" +
                ...
                "Personalización: " + personalizaciones.toString() + "\n" +
